...
> 이 문서는 2026-07-31 기준의 구현 스냅샷입니다. 최신 구현 상태는 `README.md`, `docs/API_SPEC.md`, `docs/DATA_MODEL.md`를 기준으로 확인합니다. 특히 대시보드 mock fallback과 개발용 사용자 전환은 현재 구현에 포함되지 않습니다.
